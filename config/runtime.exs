...
#
#     PHX_SERVER=true bin/federated_elixir start
#
...
if config_env() == :prod do
  ...
  config :federated_elixir, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :federated_elixir, FederatedElixir.Mailer,
