defmodule FederatedElixir.Accounts.User do
  ...
  schema "users" do
    ...
    field :subscribe_to_newsletter, :boolean, default: false
  ...
  The :subscribe_to_newsletter field is false by default
  ...
  def registration_changeset(user, attrs, opts \\ []) do
    user
    |> cast(attrs, [:email, :subscribe_to_newsletter])
    |> validate_email(opts)
  end

  @doc """
  A user changeset for changing the email inside settings.
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, FederatedElixir.Repo)
  ...
  """
  def valid_password?(%FederatedElixir.Accounts.User{hashed_password: hashed_password}, password)
